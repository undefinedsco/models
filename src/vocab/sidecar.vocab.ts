...
export const InputRequestVocab = {
  session: UDFS.session,
  chat: UDFS.conversation,
  thread: UDFS.inThread,
  run: UDFS.run,
  task: UDFS.task,
  requester: UDFS.requester,
  requestKind: UDFS.requestKind,
  prompt: UDFS.prompt,
  context: UDFS.context,
  inputOptions: UDFS.inputOptions,
  status: UDFS.status,
  leaseOwner: UDFS.leaseOwner,
  leaseExpiresAt: UDFS.leaseExpiresAt,
  assignedTo: UDFS.assignedTo,
  response: UDFS.response,
  answeredBy: UDFS.answeredBy,
  onBehalfOf: UDFS.onBehalfOf,
  reason: UDFS.reason,
