...
export const UDFS = createNamespace('udfs', 'https://undefineds.co/ns#', {
  ...
  DocumentUnderstandingModel: 'DocumentUnderstandingModel',
  ...
  RerankingCapability: 'RerankingCapability',
  ToolCallCapability: 'ToolCallCapability',
  ReasoningCapability: 'ReasoningCapability',
  WebCapability: 'WebCapability',
  VisionCapability: 'VisionCapability',
  OCRCapability: 'OCRCapability',
  DocumentUnderstandingCapability: 'DocumentUnderstandingCapability',
  StructuredOutputCapability: 'StructuredOutputCapability',
  IndexingCapability: 'IndexingCapability',
  ImageGenerationCapability: 'ImageGenerationCapability',
  SpeechRecognitionCapability: 'SpeechRecognitionCapability',
  SpeechSynthesisCapability: 'SpeechSynthesisCapability',
  VideoGenerationCapability: 'VideoGenerationCapability',
  AIConfig: 'AIConfig',
  Note: 'Note',
  ...
  ChatProjectContext: 'ChatProjectContext',
  ...
  noteKind: 'noteKind',
  representationMediaType: 'representationMediaType',
  readerEngine: 'readerEngine',
  readerVersion: 'readerVersion',
  generatedWithModel: 'generatedWithModel',
  readerOptionsHash: 'readerOptionsHash',
  ...
  pdfRecognition: 'pdfRecognition',
  tableRecognition: 'tableRecognition',
